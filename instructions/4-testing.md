...
4. To validate that your skill is working as expected, invoke your skill from the **Alexa Simulator**. You can either type or click and hold the mic from the input box to use your voice.
	1. **Type** "Apri" followed by the invocation name you gave your skill in [Step 1](./1-voice-user-interface.md). For example, "Apri mucca parlante".
	2. **Use your voice** by clicking and holding the mic on the side panel and saying "Apri" followed by the invocation name you gave your skill.
